...
public class Constant_OnboardingPage {
    ...
    public static String Onboarding_YES_Button_xpath="//*[@resource-id='android:id/button1']";
    ...
    public static final String onboarding_popup_content_container_xpath="//*[@resource-id='com.android.permissioncontroller:id/content_container']";
